...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-387%20passing-14B8A6" alt="387 tests">
...
387 assertions. No network beyond a server the suite starts itself, and no API key — the model path runs through an injected fake client. The browser suite adapts to whether Playwright is present rather than skipping silently.
